...
| ---------- | ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --- | ----------------------------------------------------------------- |
| 2026-03-13 | self   | Kept using string interpolation for dynamic Tailwind classes (e.g., `` `foo${condition ? ' bar' : ''}` ``) despite being corrected multiple times                       | ALWAYS use `tv()` with variants for conditional classes. Never use string interpolation in classNames — this is a hard rule in this project                                                                                                                                    |
| 2026-03-13 | user   | Used `React.ReactNode` for type annotation                                                                                                                               | Always import named types (`import type { ReactNode } from 'react'`) — never use `React.` namespace prefix                                                                                                                                                                    |
