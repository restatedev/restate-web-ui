...
//               the named shortcuts (In-flight, Held up, Scheduled, …).
...
export function InvocationsSidebarItem({
  ...
  // Requested rail order: Running, In-flight, Held up, then All, then the
  ...
  // Fixed rail presets (Running, In-flight, Held up, All) don't appear here —
