        ...
        <div className="p-0.5 flex items-center rounded-xl border-transparent ring-1 ring-transparent border has-[*:focus]:border-blue-500 has-[*:focus]:ring-blue-500">
          ...
          >
            ...
            <div className="relative min-w-0 flex-auto pr-[5.5rem] h-full">
              <div
                className="[&&&_.suggest-widget_.monaco-list_.monaco-list-row:hover.string-label>.contents>.main>.right>.readMore]:visible [&&&_.suggest-widget_.monaco-list_.monaco-list-row:hover.string-label>.contents>.main>.right>.readMore]:block [&&&_.suggest-widget_.monaco-list_.monaco-list-row>.contents>.main>.right]:mr2-[28px] [&&&_.suggest-widget_.monaco-list_.monaco-list-row>.contents>.main>.right]:max-width2-full [&&&_.suggest-widget_.monaco-list_.monaco-list-row:hover>.contents>.main>.right>.details-label]:text-white [&&&_.suggest-widget_.monaco-list_.monaco-list-row:hover>.contents>.main>.right>.details-label]:block [&_.readMore:before]:[line-height:28px] [&_.codicon-symbol-struct:before]:!content-['\ebb7'] [&_.codicon-symbol-function:before]:!content-['\ec24'] [&_.suggest-widget_.monaco-list]:rounded-lg [&_.suggest-widget_.monaco-list_.monaco-list-row:hover>.contents>.main_.monaco-highlighted-label_.highlight]:!text-blue-200 [&_.suggest-widget_.monaco-list_.monaco-list-row.focused>.contents>.main_.monaco-highlighted-label_.highlight]:!text-blue-200 [&_.suggest-widget_.monaco-list_.monaco-list-row:not(.focused):not(:hover)>.contents>.main_.monaco-highlighted-label_.highlight]:!text-blue-500 [&_.suggest-widget_.monaco-list_.monaco-list-row:not(:hover):not(.focused)_.codicon]:!text-blue-500 [&_.suggest-widget_.monaco-list_.monaco-list-row:hover_.codicon]:!text-white [&_.suggest-widget_.monaco-list_.monaco-list-row.focused_.codicon]:!text-white [&_.monaco-list-row.monaco-list-row.monaco-list-row]:pl-1.5 [&_.monaco-list-row.monaco-list-row.monaco-list-row]:rounded-xl [&_.suggest-widget_.monaco-list_.monaco-list-row:not(.focused):not(:hover)>.contents>.main_.monaco-icon-label.monaco-icon-label.monaco-icon-label]:text-gray-700 [&_.monaco-list-row.monaco-list-row.monaco-list-row.focused]:bg-blue-600 [&_.monaco-list-row.monaco-list-row.monaco-list-row:hover]:!bg-blue-600  [&_.monaco-list-row.monaco-list-row.monaco-list-row.focused]:text-white [&_.monaco-list-row.monaco-list-row.monaco-list-row:hover]:text-white [&_.suggest-details.suggest-details.suggest-details]:bg-gray-100/80 [&_.suggest-details.suggest-details.suggest-details]:backdrop-blur-xl [&_.suggest-details.suggest-details.suggest-details]:backdrop-saturate-200 [&_.suggest-details.suggest-details.suggest-details]:shadow-lg [&_.suggest-details.suggest-details.suggest-details]:rounded-xl [&_.suggest-details.suggest-details.suggest-details]:bg-clip-padding [&_.suggest-details.suggest-details.suggest-details]:border [&_.suggest-details.suggest-details.suggest-details]:border-black/10 [&_.suggest-details.suggest-details.suggest-details]:text-slate-700 [&_.suggest-widget.suggest-widget.suggest-widget]:bg-gray-100/80 [&_.suggest-widget.suggest-widget.suggest-widget]:backdrop-blur-xl [&_.suggest-widget.suggest-widget.suggest-widget]:backdrop-saturate-200 [&_.suggest-widget.suggest-widget.suggest-widget]:shadow-lg [&_.suggest-widget.suggest-widget.suggest-widget]:rounded-xl [&_.suggest-widget.suggest-widget.suggest-widget]:bg-clip-padding [&_.suggest-widget.suggest-widget.suggest-widget]:border [&_.suggest-widget.suggest-widget.suggest-widget]:border-black/10 [&_.suggest-widget.suggest-widget.suggest-widget]:text-slate-700 [&_.monaco-editor]:outline-none h-full [&_textarea]:[box-shadow:none] [&_textarea]:border-none [&_textarea]:outline-none"
                ref={hostRef}
              />
            </div>
          </div>
