      ...
      >
        ...
        >
          ...
          <div className="text-2xs flex items-center gap-0.5  mt-0.5">
            <kbd className="text-[80%] font-mono font-medium rounded bg-black/20  text-white/90 px-1">
              {getMetaKeySymbol()}
            </kbd>
            <div className="text-[120%] font-mono font-medium rounded bg-black/20 px-1 h-5 flex items-center justify-center text-white/90 aspect-square">
              ⏎
            </div>
          </div>
        </SubmitButton>
