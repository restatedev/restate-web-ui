...
export const TABLES = [
  ...
  },
  {
    ...
    description: '',
    columns: [
      { name: 'partition_key', description: '' },
      { name: 'id', description: '' },
      { name: 'stage', description: '' },
      { name: 'status', description: '' },
      { name: 'has_lock', description: '' },
      { name: 'run_at', description: '' },
      { name: 'sequence_number', description: '' },
      { name: 'entry_id', description: '' },
      { name: 'entry_kind', description: '' },
      ...
      { name: 'latest_attempt_at', description: '' },
      { name: 'first_runnable_at', description: '' },
