...
export function TimeRangeToggle({ onChange }: { onChange?: () => void }) {
  ...
  return (
    <div
      onClick={handleClick}
      className="[&_[data-active=true]]:font-medium [&_[role=row]]:py-0.5 [&_a]:px-5 [&_a]:py-1 [&_a]:text-xs [&>div]:border-[0.5px] [&>div]:border-zinc-800/5 [&>div]:bg-black/3 [&>div]:shadow-[inset_0_1px_0px_0px_rgba(0,0,0,0.03)]"
    >
