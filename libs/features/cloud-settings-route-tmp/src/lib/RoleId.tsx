...
const styles = tv({
  base: '[text-decoration:none] bg-blue-50 text-blue-800 ring-blue-600/20 inline-flex gap-1 items-center rounded-lg px-2 py-0.5 text-sm font-medium ring-1 ring-inset',
});
