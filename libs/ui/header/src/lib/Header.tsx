...
const headerStyles = tv({
  slots: {
    ...
    icon: 'absolute top-1/2 -left-1 flex h-14 w-14 -translate-y-1/2 items-center justify-center rounded-2xl border border-gray-200/90 bg-linear-to-br from-white via-white to-zinc-50 text-indigo-500/80 shadow-[0_2px_4px_-1px_--theme(--color-zinc-800/10%),0_14px_26px_-12px_--theme(--color-zinc-800/25%),inset_0_2px_0_0_--theme(--color-white)]',
    iconBadge:
      'flex h-8 w-8 rotate-3 items-center justify-center rounded-lg bg-indigo-50/80 shadow-[0_2px_6px_-5px_--theme(--color-indigo-900/35%),inset_0_1px_0_0_--theme(--color-white/80%)] ring-1 ring-indigo-200/60',
