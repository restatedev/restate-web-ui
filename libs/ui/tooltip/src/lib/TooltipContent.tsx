...
const styles = tv({
  base: 'group max-w-md border border-zinc-900/80 text-gray-300 drop-shadow-xl will-change-transform',
  variants: {
    isEntering: {
    ...
    size: {
      ...
      default:
        'rounded-2xl bg-zinc-800/90 p-4 text-sm shadow-[inset_0_1px_0_0_var(--color-gray-500)] backdrop-blur-xl',
    },
  },
  defaultVariants: {
    size: 'default',
