...
export function AppBar(props: PropsWithChildren<AppBarProps>) {
  return (
    <>
      <div className='fixed top-0 right-0 left-0 z-30 hidden h-6 bg-gray-100 mask-[linear-gradient(to_top,rgba(0,0,0,1)_0%,black_100%)] [&:has(+header_[data-variant="hidden"])]:hidden [&:has(+header>*>*)]:block' />
      <header
