...
export function Toolbar(props: PropsWithChildren<ToolbarProps>) {
  return (
    <div className="sticky bottom-0 z-10 hidden min-h-20 max-w-full items-center justify-center bg-linear-to-b from-transparent to-gray-100/80 [&:has(>*>*)]:flex [body:has([data-content-panel-fill-viewport])_&]:-mt-20">
      <div
        {...props}
