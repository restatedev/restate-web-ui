...
export function ComplementaryOutlet(
  ...
  return (
    <>
      ...
      />
      <aside
        className="[&:has(>*>*)]:duration-250 [&:has(>*>*)]:animate-in [&:has(>*>*)]:slide-in-from-right [&:has(>*>*)]:fade-in [&:not(has(>*>*))]:duration-250 flex flex-col top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 sm:translate-y-0 sm:translate-x-0 sm:top-24 3xl:top-[calc(0.75rem+3.5rem+2.5rem)] 3xl:pt-10 [&:not(:has([data-complementary-content]>*))]:hidden fixed z-[100] sm:z-50 lg:right-8 sm:right-6 right-auto sm:left-auto lg:bottom-6 sm:bottom-6 max-h-[90vh] max-w-[100vw] sm:max-h-none lg:max-h-none 3xl:h2-fit 3xl:max-h-[1400px] 3xl:right-[calc(50vw-min(50rem,calc(50vw-350px-2rem))-350px)]
]"
      >
        <div
          {...props}
