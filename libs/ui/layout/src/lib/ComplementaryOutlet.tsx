...
export function ComplementaryOutlet(
  ...
  return (
    <>
      ...
      <aside className="h-fit 3xl:sticky top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 sm:translate-y-0 sm:translate-x-0 sm:top-auto 3xl:top-[calc(0.75rem+3.5rem+2.5rem)] 3xl:px-0 3xl:pt-14 [&:not(:has([data-complementary-content]>*))]:hidden fixed z-50 lg:right-8 sm:right-6 right-auto sm:left-auto lg:bottom-8 sm:bottom-6 bottom-3 max-w-[100vw] 3xl:max-h-auto max-h-[calc(100vh-4rem-4rem)] sm:max-h-[calc(100vh-1.5rem-1.5rem-1.5rem-3.5rem)] lg:max-h-[calc(100vh-2rem-2rem-1.5rem-3.5rem)] 3xl:max-h-none">
        <div
          {...props}
